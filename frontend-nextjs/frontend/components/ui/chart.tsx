...
function getPayloadConfigFromPayload(
  ...
  type PayloadWithPayload = { payload?: Record<string, unknown> };

  function hasPayloadField(
    v: unknown
  ): v is PayloadWithPayload & Record<string, unknown> {
    return (
      typeof v === "object" &&
      v !== null &&
      "payload" in v &&
  ...
  const payloadPayload = hasPayloadField(payload) ? payload.payload : undefined;
